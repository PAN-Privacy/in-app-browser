...
export interface InAppBrowserOptions {
    ...
    /**
     * Help Popup text,
     * Text that is shown inside of a popup when the help button is clicked.
     */
    ...
    /**
     * Footer Image name with extension
     * Image should be placed in the assets/icon/ folder.
     */
    footerImage?: string;
    /**
     * (Android only)
    ...
    /**
     * (iOS only)
     * Footer text font family name and not the file name.
     */
    iosFooterFontFamily?: string;
    /**
     * (Android only)
     * Location text font family.
     * font file should be placed in the /assets/fonts/ folder.
     * Please Note: Only .ttf fonts are supported.
     */
    ...
    /**
     * (iOS only)
     * Location text font family name and not the file name.
     */
    iosLocationFontFamily?: string;
    /**
     * (Android only)
    ...
    /**
     * (iOS only)
     * Help text font family name and not the file name.
     */
    iosHelpFontFamily?: string;
    /**
     * (Android only)
    ...
    /**
     * (iOS only)
     * Close text font family name and not the file name.
     */
    iosCloseButtonFontFamily?: string;
    /**
